    ...
    <div className="flex flex-col sm:flex-row h-screen bg-gray-100">
      ...
      <div className="flex-1">
        ...
        <div className="p-4 sm:p-6">
          <h2 className="text-xl sm:text-2xl font-semibold mb-4">Bookings Details</h2>
      ...
      {expandedBooking && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            <p><strong>Room No:</strong> {expandedBooking.tour}</p>
            <p><strong>User:</strong> {expandedBooking.user}</p>
            <p><strong>Email:</strong> {expandedBooking.email}</p>
            <p><strong>Date:</strong> {expandedBooking.date}</p>
            <p><strong>Guests:</strong> {expandedBooking.participants}</p>
