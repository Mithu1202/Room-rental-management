...
const onlyNotification = true  //itha vachu toggle pannu da homepage mode 

const HomePage = () => {
  const [notification, setNotification] = useState([
    {
      title: 'Notificaiton1',
      message: 'messageflajdfljadslfjlajdl;fjal;sdjfl;jaldjflajsdlfjl;asjdlfjlas',
      img: '/cus.png'
    },
    {
      title: 'Notificaiton2',
      message: 'dfadfasdfasdfasdfq;fjal;sdjfl;jaldjflajsdlfjl;asjdlfjlas',
      img: '/cus2.png'
    },
    {
      title: 'Notificaiton3',
      message: '12321231;fjal;sdjfl;jaldjflajsdlfjl;asjdlfjlas',
      img: '/cus3.png'
    },
    {
      title: 'Notificaiton4',
      message: '////dfadf32323rwd3;fjal;sdjfl;jaldjflajsdlfjl;asjdlfjlas',
      img: '/cus.png'
    }
  ])
  return (
    <div>
      ...
      {/* Services Section */}
      <section className="py-16 flex-column px-40">
        {
          notification.map(
            note => 
              <div className='py-4'>
                <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-12 px-6">
                  <div className="bg-white shadow-lg rounded-lg overflow-hidden flex">
                    <div><img src={note.img} alt="Custom Tour" className="w-full h-28 object-cover"/></div>
                    <div className="p-6">
